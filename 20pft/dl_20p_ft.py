...
class baseline_dataloader_train_strong(Dataset):
    ...
    def __init__(self, shuffle = True, data_percentage = 1.0):
        self.labeled_datapaths = open(os.path.join(cfg.path_folder,'UCF_train_paths.txt'),'r').read().splitlines()
...
if __name__ == '__main__':
    ...
    train_dataset = multi_baseline_dataloader_val_strong(shuffle = False, data_percentage = 1.0,  mode = 9)
    # train_dataset = baseline_dataloader_train_strong(shuffle = False, data_percentage = 1.0)
