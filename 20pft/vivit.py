...
class ViViT(nn.Module):
    def __init__(self, image_size, patch_size, num_frames, num_classes = 102, dim = 192, depth = 4, heads = 3, pool = 'cls', in_channels = 3, dim_head = 64, dropout = 0.,
...
if __name__ == "__main__":
    ...
    model = ViViT(224, 16, 16, 100, pool='cls')#.cuda()
